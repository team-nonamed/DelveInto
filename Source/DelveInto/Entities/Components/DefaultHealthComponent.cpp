...
// // 	// {
// // 	// 	Owner->OnTakeAnyDamage.AddDynamic(this, &UHealthComponent::ApplyInstigation);
// // 	// }
// // }
// //
// // bool UHealthComponent::ApplyInstigation(const FHealthInstigation& Instigation)
// // {
// // 	
// // 	switch (Instigation.InstigationType)
// // 	{
// // 	case EHealthInstigationType::Heal:
// // 		FHealthChangeContext Context = FHealthChangeContext();
// // 		
// // 		ApplyRecover()
// // 	}
// // }
...
// // }
//
// #include "Entities/Components/DefaultHealthComponent.h"
//
// FHurtResult UDefaultHealthComponent::ApplyHurtRequest(const FHurtRequest& Request)
// {
// 	// Modifiers = Modifiers.FilterByPredicate([](const TScriptInterface<IHurtModifier>& Item)
// 	// {
// 	// 	return Item != nullptr;
// 	// });
// 	//
