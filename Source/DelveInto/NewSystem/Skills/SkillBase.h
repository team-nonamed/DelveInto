...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FOnSkillHitSignature, class USkillBase*, InstigatorSkill, AActor*, Victim, float, BaseDamage);
...
protected:
	...
	virtual void ProcessHit(AActor* HitActor, float InBaseDamage);
